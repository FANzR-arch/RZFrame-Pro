...
import { getLogoFilename } from './src/config/brands.js';

// === NAMESPACE EXPOSURE ===
// Create a localized namespace to prevent pollution and organize logic
const RZApp = {
...
// Expose ONLY the namespace to window
window.RZApp = RZApp;
...
function tryLoadBrandLogo(make) {
    return new Promise((resolve) => {
        ...
        // Security Update: Use rz-local protocol
